 ...
 */
 ...
 $sidebar = $neder_theme['neder_panel_tag_sidebar_position'];
     ...
     <!-- start:sidebar none - full width -->
        <div class="neder-content col-xs-12 post-full-width <?php echo esc_html($layout_type); ?>">
		    <h2 class="neder-title-page-container">
				<span class="neder-title-page"><?php printf( esc_html__( 'Tag Archives: %s', 'neder' ), single_tag_title( '', false ) ); ?></span>
            </h2>		
            <!-- start:page content -->

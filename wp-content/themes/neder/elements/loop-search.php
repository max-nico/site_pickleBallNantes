 ...
 */
 ...
 /* Layout */ 
 $blog_layout = $neder_theme['neder_panel_search_layout'];
 
 if(!isset($blog_layout) || $blog_layout == '') : $blog_layout = 'neder-posts-layout1'; endif; 

 /* Columns */
 $columns = $neder_theme['neder_panel_search_columns'];
 ...
 /* Layout Type */
 $blog_type = $neder_theme['neder_panel_search_layout_type'];
...
<?php 
 ...
 # end:pagination active
      ...
      <article class="item-posts first-element-posts"> 
       		<div class="post-text search-not-found not-found">
				<p><?php esc_html_e('No relevant search results found. Try a different search keyword. ', 'neder'); ?></p>				
				<p>
					<form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						<div>
							<input type="text" class="search-field" value="" name="s" id="s" />
							<input type="submit" id="searchsubmit" class="search-submit" value="<?php echo esc_attr_e( 'Search', 'neder' ); ?>" />
						</div>
					</form>
				</p>
       		</div>

 ...
 */
 ...
 /* Layout */ 
 if(is_archive()) : $blog_layout = $neder_theme['neder_panel_archive_layout']; endif;
 if(is_author()) : $blog_layout = $neder_theme['neder_panel_author_layout']; endif;
 if(is_tag()) : $blog_layout = $neder_theme['neder_panel_tag_layout']; endif;

 if(!isset($blog_layout) || $blog_layout == '') : $blog_layout = 'neder-posts-layout1'; endif; 

 /* Columns */
 if(is_archive()) : $columns = $neder_theme['neder_panel_archive_columns']; endif;
 if(is_author()) : $columns = $neder_theme['neder_panel_author_columns']; endif;
 if(is_tag()) : $columns = $neder_theme['neder_panel_tag_columns']; endif;
 ...
 /* Layout Type */
 if(is_archive()) : $blog_type = $neder_theme['neder_panel_archive_layout_type']; endif;
 if(is_author()) : $blog_type = $neder_theme['neder_panel_author_layout_type']; endif;
 if(is_tag()) : $blog_type = $neder_theme['neder_panel_tag_layout_type']; endif;
...
<div class="neder-element-posts <?php echo esc_html($class_item_masonry); ?> <?php echo esc_html($class_load_more); ?> <?php echo esc_html($blog_layout); ?> <?php echo esc_html($container_class); ?> element-no-padding">
 ...
 $link = get_permalink();
	...
	if ( is_sticky() ) : 
		$sticky_class = 'neder-post-sticky'; 
	else : 
		$sticky_class = ''; 
	endif; 
 ...
 ?> 
  ...
  <?php if($blog_layout == 'neder-posts-layout1') :?>
	 ...
	 <article class="item-posts first-element-posts <?php echo esc_html($columns_class); ?> <?php echo esc_html($sticky_class); ?>">

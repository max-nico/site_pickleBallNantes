<?php
$attchments_fastgallery_options = array(    
    'custom_url' => array(
        'label'       => __('Custom Url', 'fastgallery'),
        'input'       => 'text',
        'application' => 'image',
...
Class FastGallery_Custom_Medias_Fields {
...
$fgcmf = new FastGallery_Custom_Medias_Fields($attchments_fastgallery_options);
<?php
$attchments_fastcarousel_options = array(    
    'custom_url' => array(
        'label'       => __('Custom Url', 'fastcarousel'),
        'input'       => 'text',
        'application' => 'image',
...
Class fastcarousel_Custom_Medias_Fields {
...
$fgcmf = new fastcarousel_Custom_Medias_Fields($attchments_fastcarousel_options);
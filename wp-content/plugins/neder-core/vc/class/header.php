...
class neder_header_display_class {
    function __construct() {
        add_action( 'init', array( $this, 'integrate_neder_header_displayWithVC' ) );
        add_shortcode( 'neder_header_display', array( $this, 'neder_header_display_function' ) );	
    }
 
    public function integrate_neder_header_displayWithVC() {
		...
		vc_map( array(
            "name" => esc_html__("Header Posts", 'neder-core'),
            "description" => esc_html__("Display your posts", 'neder-core'),
            "base" => "neder_header_display",
            "class" => "neder",
            "controls" => "full",
            ...
            "params" => array(						
				array(
						"type" => "textfield",
						"class" => "",
						"heading" => esc_html__("Header Display Name",'neder-core'),
						"param_name" => "name",
						"admin_label" => true,				  				  			  				  
				),		
                array(		
					  ...
					  "value" => array(
										...
										esc_html__('Type 4 (Carousel)','neder-core') 		=> 'type4',
				...
				array(
					  "type" => "textfield",
					  "class" => "",
					  "heading" => esc_html__("Post to load",'neder-core'),
					  "param_name" => "num_posts",
					  "description" => "Add the number of posts to load on carousel header. Default value: all posts",
				   		"dependency" => array(
							'element' => 'type',
							'value' => array( 'type4' )
				   		),					  					  
...
new neder_header_display_class();
?>
